...
# REQUIRED_GENRE = set(['House', 'Trip-Hop', 'Dubstep', 'Dance', 'Pop'])
...
# Each individual is a playlist, i.e. a list of filenames
# A random list of playlist serves as the initial population

# Fitness function
# We will calculate several sccores based on changes in beats-per-minute, diversity of genres,
# overal interest level in the songs, etc.

# Selection function
# Build-in DEAP selection function

# Crossover function
# Build-in DEAP crossover function for lists: take a part of the list and a part of the second list and join them

# Mutation function
# Add or more a random track to/from the playlist
